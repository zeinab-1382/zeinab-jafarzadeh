			...
			<div class="header-body-left">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
					    ...
					    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo asset('management-panel/posts/createPosts.php'); ?>"> صفحه ایجاد محصول</a></li>
					</ol>
				</nav>
				<!-- end::breadcrumb -->
			</div>
							...
							<tr>
                                ...
                                <td class="text-center align-middle">
                                    <figure class="avatar avatar">
										<img src="<?php echo  asset("functions/images/posts-image/".$post->image); ?>" class="rounded-circle" alt="image">
									</figure>
                                </td>
								<td class="text-center align-middle"><?php echo $post->title ?></td>
                                <td class="text-center align-middle"><?php echo getUserById($post->user_id)->firstname," ",getUserById($post->user_id)->lastname ?></td>
                                <td class="text-center align-middle"><?php echo getCategoryById($post->category_id)->title ?></td>
                                <td class="text-center align-middle"><?php echo status($post->status) ?></td>
								<td class="text-center align-middle">
								    <a class="btn btn-outline-info" href="<?php echo url('/management-panel/posts/deletePosts.php?id=').$post->id; ?>">
										حذف
									</a>
								</td>
								<td class="text-center align-middle">
									<a class="btn btn-outline-info" href="<?php echo url('/management-panel/posts/editPosts.php?id=').$post->id; ?>">
										ویرایش
									</a>
								</td>
								<td class="text-center align-middle"><?php echo $post->created_at ?></td>
